...
public class JointTransformation {
	// remember, this position and rotation are relative to the parent bone!
		private final Vector3f position;
		private final Quaternion rotation;
		
		public JointTransformation(Vector3f position, Quaternion rotation) {
		...
		protected static JointTransformation interpolate(JointTransformation frameA, JointTransformation frameB, float progression) {
			...
			return new JointTransformation(pos, rot);
		}
